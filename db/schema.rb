...
ActiveRecord::Schema[8.1].define(version: 2025_10_12_205951) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.check_constraint "status IS NULL OR (status::text = ANY (ARRAY['active'::character varying::text, 'archived'::character varying::text, 'draft'::character varying::text, 'unlisted'::character varying::text]))", name: "check_products_status"
  end
  ...
  create_table "variants", force: :cascade do |t|
    ...
    t.check_constraint "recordable_type IS NULL OR (recordable_type::text = ANY (ARRAY['SingleTrack'::character varying::text, 'Album'::character varying::text, 'AlbumTrack'::character varying::text]))", name: "check_variants_recordable_type"
